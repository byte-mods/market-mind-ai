...
| **Indian moat** | Tax-aware rebalancer (STCG/LTCG, ₹1.25L exemption, FY tracking) | ⏳ in progress |
| | Multi-asset (MCX commodities, USD/INR, INR-paired crypto) | ⏳ |
| | SEBI compliance gate (insider window, position limits, PDA audit) | ⏳ |
| **Frontier** | Causal Bayesian network (PC-algorithm + dowhy counterfactuals) | ⏳ |
